...
var Dg = (function () {
     ...
     * speed 速度
     */
    function Dg(shape, datas, idx, speed, g_off_h, g_off_w) {
        this.g_sub_idx = 0;
        this.g_idx = 1; //第几行
        this.g_data_idx = 0;
    ...
    Dg.prototype.dealArrayBuff = function (that) {
    ...
    Dg.prototype.drawCanvas = function (that) {
    ...
    Dg.prototype.ecgDrawGrid = function () {
