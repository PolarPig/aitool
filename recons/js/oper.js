...
//			console.log(data);
			...
			if (data.ecg_level < 0) {
				...
				// 2. 获取原始采样点
				getHeartDataByUrl("http://192.168.9.220:8081/pacs/get_ecg_voltage?file=" + data.rrDats + "&begin=1&end=300&filter=0&reduce_sampling_rate=0", function (ecgdata, startTime, dataLength) {
