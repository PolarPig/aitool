...
var get_original_data = function (reportId) {
    ...
    fetch(url, param).then(res => {
        ...
        if (data.respHead.respCode === "000") {
            ...
            getHeartDataByUrl(`http://192.168.9.220:8081/pacs/get_ecg_voltage?file=${data.body.data}&begin=1&end=300&filter=1&reduce_sampling_rate=0`, function (data, startTime, dataLength) {
